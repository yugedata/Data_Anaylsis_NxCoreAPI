...
////////////////////////////////////////////////////
template <class T> T NxCoreProcAddr(HMODULE hLib,const char *pfName)
{
  ...
  unsigned int LoadNxCore(const char* cszNxCoreLib)
  {
	...
	if( hLib ) {
	  if((pfAPIVersion		  = NxCoreProcAddr<NxCoreAPIVersion>		(hLib,cszNxCoreAPIVersion))			&&
		...
		pfSetCallback	   = NxCoreProcAddr<NxCoreSetCallback>(hLib,cszNxCoreSetCallback);
		pfGetSymbolAtom32  = NxCoreProcAddr<NxCoreGetSymbolAtom32>(hLib,cszNxCoreGetSymbolAtom32);
