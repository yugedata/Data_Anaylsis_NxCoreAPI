...
#define NxCoreAPI_h
////////////////////////////////////////////////////////////////////////////////////////////////////////
//	CONTENTS COPYRIGHT 2003-2015(c) Nanex, LLC, Winnetka, IL. ALL RIGHTS RESERVED.					  //
...
version	 date		  note
-------------------------------
2.3.198  2007.04.16	  added additional alignment fields for consistent structure sizes for packing sizes 1,2,4,8 and 16. NxCoreAPI.dll is compiled with packing set at 8 bytes.
*/
...
//////////////////////////////////////////////
struct NxAccessStatus { // 48/48 bytes
...
struct NxCoreSystem { // 76/104 bytes
...
////////////////// NxCoreQuote //////////////////////////////////////
/////////////////////////////////////////////////////////////////////
struct NxCoreQuote {// 40/40 bytes.
...
struct NxCoreTrade {  // 88/88 bytes.
	...
	int						NetChange;
	// NxCore3
	unsigned char			ExtTradeConditions[4];		// 2015.11.11 changed from alignment[4] to ExtTradeConditions --- //2.3.198, 2007.04.16
};
...
union NxCoreData {	// 88/88 bytes
	NxCoreExgQuote		ExgQuote;		// 88/88 bytes
	NxCoreMMQuote		MMQuote;		// 48/56 bytes
	NxCoreTrade			Trade;			// 88/88 bytes
	NxCoreCategory		Category;		// 12/24 bytes
	NxCoreSymbolChange	SymbolChange;	// 16/32 bytes
	NxCoreSymbolSpin	SymbolSpin;		// 20/20 bytes
};
...
struct NxCoreStateExgQuotes { // 248/488 bytes
...
struct NxCoreAPIDLLFile { // 304/304 bytes
	...
	NxDate			  BuildDate;	// 16/16 bytes
	NxTime			  BuildTime;	// 16/16 bytes
